...
from nodestream_akamai.akamai_utils.property_client import NoRuleFoundError
...
@pytest.mark.asyncio
async def test_extract_records_fail_no_rule(extractor):
    ...
    extractor.client.describe_property_by_dict = Mock(side_effect=NoRuleFoundError)
